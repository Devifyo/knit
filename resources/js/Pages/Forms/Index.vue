...
const form = useForm({ name: '', nurture_workflow_id: '' });
const submit = () => form.post('/forms', { preserveScroll: true, onSuccess: () => { open.value = false; form.reset(); } });
...
<template>
    ...
    <div class="space-y-5">
        ...
        <Modal :open="open" title="New capture form" @close="open = false">
            <p class="mb-4 text-sm text-muted">Ships with Name / Email / Phone fields. Pick a workflow to enrol every submission into automatically.</p>
